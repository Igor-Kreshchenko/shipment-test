...
type Shipment struct {
	...
	SenderCountryCode    string  `json:"senderCountryCode" validate:"required,iso3166_1_alpha2"`
	...
	RecipientCountryCode string  `json:"recipientCountryCode" validate:"required,iso3166_1_alpha2"`
